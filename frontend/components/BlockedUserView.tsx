...
import { createAppeal } from '@/lib/api/admin';
...
export default function BlockedUserView() {
    ...
    const handleSendAppeal = async () => {
        ...
        try {
            ...
            toast.success("Your message has been sent to superadmin");
            setSent(true);
            setMessage('');
        } catch (error: any) {
            ...
            <div className="max-w-2xl w-full bg-zinc-900/50 backdrop-blur-sm border border-red-500/20 rounded-3xl p-8 shadow-2xl">
                <div className="flex items-start gap-4 mb-6">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-zinc-400">
                            Your account has been blocked by a superadmin. You cannot use any features including chat, RAG, MCP, or LLM configurations.
                        </p>
                    </div>
                </div>
                ...
                <div className="bg-red-500/5 border border-red-500/10 rounded-xl p-4 mb-6">
                    ...
                    <ul className="list-disc list-inside text-sm text-zinc-400 mt-2 space-y-1">
                        <li>Send a message to superadmin requesting account unblocking</li>
                ...
                {!sent ? (
                    <div className="space-y-4">
                        <div>
                            ...
                            <p className="text-xs text-zinc-500 mt-1">
                                Your message will be reviewed by a superadmin. You will be notified if your account is unblocked.
                            </p>
                        </div>
                    ...
                    <div className="bg-green-500/10 border border-green-500/20 rounded-xl p-6 text-center">
                        ...
                        <p className="text-zinc-400 mb-4">
                            Your message has been sent to superadmin. They will review your request and respond accordingly.
                        </p>
