...
# Daily usage limits
DAILY_REQUEST_LIMIT = 20  # Maximum requests per authenticated user per day (default LLM)
DAILY_REQUEST_LIMIT_UNAUTHENTICATED = 10  # Maximum requests per unauthenticated user per day
